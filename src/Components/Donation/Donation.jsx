    ...
    <div className="mb-32 w-[80%] mx-auto mt-10">
      ...
      <ul className="grid md:grid-cols-2 gap-5">
        {donationDetails.slice(0, dataLength).map((donation) => (
          <li key={donation.id}>
            <div
              style={{ backgroundColor: donation.card_color }}
              className="card card-side bg-base-100 shadow-xl rounded-lg"
            >
              <figure>
                <img
                  className="h-56 w-56"
              ...
              <div className="card-body ">
                <h2
                  style={{
                    backgroundColor: donation.title_color,
                    color: donation.text_color,
                  }}
                  className="card-title border w-24 h-8 rounded-lg pl-4 text-base"
                >
                  {donation.title}
                </h2>
                ...
                <button
                  ...
                  className="w-32 h-10 text-base text-white font-semibold rounded-md"
                >
                  View Details
                </button>
      ...
      <div className={dataLength === donations.length ? 'hidden' : ''}>
              <button
                ...
                className="bg-[#009444] w-[110px] h-[48px] rounded-xl text-[#FFF] text-lg font-bold ml-[47%] mt-10 mb-32"
              >
                See All
              </button>
            </div>
